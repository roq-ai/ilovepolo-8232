...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`ilovepolo`}</title>

        <meta
          name="description"
          content="Welcome to ilovepolo - Your personal platform for creating unique shirt designs. Type, upload, generate - your style, your way."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1621951753015-740c699ab970?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0LXNoaXJ0JTIwZGVzaWdufGVufDB8fHx8MTY5MTk0NTUzNnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@geoffroydanest?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Geoffroy Danest`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to ilovepolo - Your personal platform for creating unique shirt designs. Type, upload, generate - your style, your way.`}
            </Text>
            <Box
